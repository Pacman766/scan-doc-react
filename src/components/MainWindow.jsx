...
const MainWindow = React.forwardRef(({ files, activePage, scrollToPage, setMainImageRef, rotationMap, mainWindowWidth, mainWindowHeight, fitMode, scale }, mainScrollContainerRef) => {
    return (
        <div
